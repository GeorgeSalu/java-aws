package com.example.parkapi.entity;
...
public class ClienteVaga {
	...
	public String toString() {
		return "ClienteVaga [id=" + id + ", recibo=" + recibo + ", placa=" + placa + ", marca=" + marca + ", modelo="
				+ modelo + ", cor=" + cor + ", dataEntrada=" + dataEntrada + ", dataSaida=" + dataSaida + ", valor="
				+ valor + ", desconto=" + desconto + ", cliente=" + cliente + ", vaga=" + vaga + ", dataCriacao="
